              ...
              <div class="col-lg-8">
                <div class="p-15">
                  <div class="text-center">
                    <br/>
                    <h2 class="h4 text-white mb-4">Selamat Datang Admin</h2>
                  </div>
                  <form action="/login"  method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <input type="text" name='username' class="form-control form-control-user" id="exampleInputEmail"  placeholder="Username" autocomplete="off">
                    </div>
                    <div class="form-group">
                      ...
                      <br>
                      <p style ="color: rgb(199, 199, 199)">Belum punya akun? <a style="color: rgb(157, 157, 255)" href="/register">Daftar</a></p>
