...
<h6 class="m-0 font-weight-bold text-primary">Tarik Uang Kas:</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">

              <form action='/edit_tarik/{{$id->id}}' name='kirim' method='post'>
                @csrf
              ...
              <select class="form-control" name='nama' required  value="$id->siswa_id">
              <option selected disabled value="{{$id->siswa_id}}">Nama Anggota</option>
              ...
              <div class="col-sm-4">
              <label>Uang Tarik:</label>
        <input class="form-control form-control-sm" type="number" placeholder="Jumlah Uang..." aria-label=".form-control-sm example" name='jumlah' value="{{$id->tarik}}" required>
              </div>

              <div class="col-sm-4">
              <label>Tanggal Tarik:</label>
              <input class="form-control form-control-sm" type="date"  aria-label=".form-control-sm example" name='date' value="{{$id->tgl_tarik}}" required>
              </div>
              ...
              <a href="/daftar_tarik" class="btn btn-light btn-lg btn-block">Kembali</a>
