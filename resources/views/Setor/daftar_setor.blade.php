                       ...
                       echo "</div>";
                                       ...
                                       <thead>
                                         <tr>
                                           ...
                                           <th scope="col"><center>Tanggal Setor</center></th>
 ...
 -->
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><center>{{$setor->siswa->nama_siswa}}</center></td>
                                          <td><center>Rp. {{number_format($setor->setor)}}</center></td>
                                          <td><center>{{\Carbon\Carbon::parse( $setor->tgl_setor)->format('d-m-Y')}}</center></td>
                                          <td><center>&nbsp;<a href="/edit_setor/{{$setor->id}}"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="/hapus_setor/{{$setor->id}}"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp;</center></td>
