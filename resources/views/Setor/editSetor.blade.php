...
<h6 class="m-0 font-weight-bold text-primary">Setor Uang Kas:</h6>
            ...
            <div class="card-body">
              ...
              <form action='/edit_setor/{{$id->id}}' name='kirim' method='post'>
                @csrf
        ...
        <input class="form-control form-control-sm" type="number" placeholder="Jumlah Uang..." aria-label=".form-control-sm example" name='jumlah' value="{{$id->setor}}" required>
              </div>

              <div class="col-sm-4">
              <label>Tanggal Setor:</label>
              <input class="form-control form-control-sm" type="date"  aria-label=".form-control-sm example" name='date' value="{{$id->tgl_setor}}" required>
              </div>
              ...
              <a href="/daftar_setor" class="btn btn-light btn-lg btn-block">Kembali</a>
